...
import de.uniba.dsg.jaxrs.resources.ChartsResource;
...
public class ChartsService extends Application {
    ...
    public static void main(String[] args) {
        ...
        ResourceConfig config = ResourceConfig.forApplicationClass(ChartsService.class);
